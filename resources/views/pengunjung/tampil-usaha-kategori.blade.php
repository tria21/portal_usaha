        ...
        <div class="row">
                ...
                <div class="left-blog">
                  ...
                  <ul>
                    <li>
                      ...
                      <a href="{{route('tampil-usaha-kategori', $kategori)}}">Perdagangan</a>
                    </li>
                    <li>
                      @php $kategori = 'Industri Pengolahan' @endphp
                      <a href="{{route('tampil-usaha-kategori', $kategori)}}">Industri Pengolahan</a>
                    </li>
                    <li>
                      @php $kategori = 'Informasi dan Komunikasi' @endphp
                      <a href="{{route('tampil-usaha-kategori', $kategori)}}">Informasi dan Komunikasi</a>
                    </li>
                    <li>
                      @php $kategori = 'Makanan dan Minuman' @endphp
                      <a href="{{route('tampil-usaha-kategori', $kategori)}}">Makanan dan Minuman</a>
                    </li>
                    <li>
                      @php $kategori = 'Aktivitas Jasa' @endphp
                      <a href="{{route('tampil-usaha-kategori', $kategori)}}">Aktivitas Jasa</a>
                    </li>
                    <li>
                      @php $kategori = 'Lainnya' @endphp
                      <a href="{{route('tampil-usaha-kategori', $kategori)}}">Lainnya</a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="col-md-8 col-sm-8 col-xs-12">
            <div class="section-headline text-center">
              @if($dtUsahaKategori)
                @foreach($dtUsahaKategori as $kat)
