              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="col-lg-12 grid-margin stretch-card">
                    ...
                    <div class="col-1">
                      <a href="" onclick="this.href='/cetak-artikel-admin-custom/'+ document.getElementById('tglawal').value +
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th>
                            ...
                            <a hreaf="{{route('hapus-artikel-admin',$item->id)}}" class="btn btn-danger btn-sm delete" data-id="{{$item->id}}">
