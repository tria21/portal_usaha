...
<body>
  ...
  <main id="main">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <div class="well-left">
              <div class="single-well">
                <a href="#">
                  <img src="{{asset("../newsroom/assets/img/about/1.jpg")}}" alt="">
                </a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
                  <img src="{{asset("../newsroom/assets/img/team/1.jpg")}}" alt="">
                </a>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
                  <img src="{{asset("../newsroom/assets/img/team/2.jpg")}}" alt="">
                </a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
                  <img src="{{asset("../newsroom/assets/img/team/3.jpg")}}" alt="">
                </a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            <div class="single-team-member">
              <div class="team-img">
                <a href="#">
                  <img src="{{asset("../newsroom/assets/img/team/4.jpg")}}" alt="">
                </a>
                <div class="team-social-icon text-center">
                  <ul>
                    <li>
    ...
    <div class="reviews-area">
      <div class="row g-0">
        <div class="col-lg-6">
          <img src="{{asset("../newsroom/assets/img/about/2.jpg")}}" alt="" class="img-fluid">
        </div>
      ...
      <div class="container">
        ...
        <div class="row awesome-project-content portfolio-container">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-app portfolio-item">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="{{asset("../newsroom/assets/img/portfolio/1.jpg")}}" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{asset("../newsroom/assets/img/portfolio/1.jpg")}}">
                      <h4>Business City</h4>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="{{asset("../newsroom/assets/img/portfolio/2.jpg")}}" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{asset("../newsroom/assets/img/portfolio/2.jpg")}}">
                      <h4>Blue Sea</h4>
                      <span>Photosho</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-card">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="{{asset("../newsroom/assets/img/portfolio/3.jpg")}}" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{asset("../newsroom/assets/img/portfolio/3.jpg")}}">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="{{asset("../newsroom/assets/img/portfolio/4.jpg")}}" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{asset("../newsroom/assets/img/portfolio/4.jpg")}}">
                      <h4>Creative Team</h4>
                      <span>Web design</span>
                    </a>
                  </div>
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-app">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="{{asset("../newsroom/assets/img/portfolio/5.jpg")}}" alt="" /></a>
                <div class="add-actions text-center text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{asset("../newsroom/assets/img/portfolio/5.jpg")}}">
          ...
          <div class="col-md-4 col-sm-4 col-xs-12 portfolio-item filter-web">
            <div class="single-awesome-project">
              <div class="awesome-img">
                <a href="#"><img src="{{asset("../newsroom/assets/img/portfolio/6.jpg")}}" alt="" /></a>
                <div class="add-actions text-center">
                  <div class="project-dec">
                    <a class="portfolio-lightbox" data-gallery="myGallery" href="{{asset("../newsroom/assets/img/portfolio/6.jpg")}}">
                      <h4>Night Hill</h4>
                      <span>Photoshop</span>
                    </a>
                  </div>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset("../newsroom/assets/img/testimonials/testimonials-1.jpg")}}" class="testimonial-img" alt="">
                <h3>Saul Goodman</h3>
                <h4>Ceo &amp; Founder</h4>
                <p>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset("../newsroom/assets/img/testimonials/testimonials-2.jpg")}}" class="testimonial-img" alt="">
                <h3>Sara Wilsson</h3>
                <h4>Designer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset("../newsroom/assets/img/testimonials/testimonials-3.jpg")}}" class="testimonial-img" alt="">
                <h3>Jena Karlis</h3>
                <h4>Store Owner</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset("../newsroom/assets/img/testimonials/testimonials-4.jpg")}}" class="testimonial-img" alt="">
                <h3>Matt Brandon</h3>
                <h4>Freelancer</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <img src="{{asset("../newsroom/assets/img/testimonials/testimonials-5.jpg")}}" class="testimonial-img" alt="">
                <h3>John Larson</h3>
                <h4>Entrepreneur</h4>
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="single-blog">
                <div class="single-blog-img">
                  <a href="blog.html">
                    <img src="{{asset("../newsroom/assets/img/blog/2.jpg")}}" alt="">
                  </a>
                </div>
                <div class="blog-meta">
                  <span class="comments-type">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="single-blog">
                <div class="single-blog-img">
                  <a href="blog.html">
                    <img src="{{asset("../newsroom/assets/img/blog/3.jpg")}}" alt="">
                  </a>
                </div>
                <div class="blog-meta">
                  <span class="comments-type">
